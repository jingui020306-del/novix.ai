...
- 跨库检索 API:
```bash
curl -X POST http://127.0.0.1:8000/api/projects/demo_project_001/kb/query_multi   -H 'content-type: application/json'   -d '{"query":"雨夜 抉择","top_k":12,"kb":[{"kb_id":"kb_style","weight":0.5},{"kb_id":"kb_docs","weight":1.0},{"kb_id":"kb_manuscript","weight":1.2}]}'
```
- 证据跳转 API:
