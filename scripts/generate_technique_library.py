...
# 一级：表达/人物/修辞/表现/结构/描写/叙事/抒情（思维导图主干）
TOP = [
    ("expression", "表达技法"),
    ("character", "人物技法"),
    ("rhetoric", "修辞艺术"),
...
SUB = {
    ...
    "character": ["欲望", "恐惧", "伤口", "伪装", "关系", "弧光", "选择", "边界", "反差", "秘密"],
...
SEED_MICRO = {
    ...
    "character": ["欲望外化", "恐惧触发", "人物伤口回声", "伪装破裂", "关系张力", "选择压力", "行为边界", "人物反差", "秘密负担", "人物弧光推进", "弱点暴露", "自我欺骗", "价值观碰撞", "旧习惯复现", "保护性谎言", "关系试探", "情绪防御", "人物误判", "代价选择", "身份压力"],
